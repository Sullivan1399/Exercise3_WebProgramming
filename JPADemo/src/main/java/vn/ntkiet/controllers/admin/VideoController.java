...
import vn.ntkiet.services.impl.VideoServiceImpl;
...
public class VideoController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(url.contains("/admin/videos")){
            ...
            Video video =
                    videoService.findById(Integer.parseInt(request.getParameter("videoId")));
            ...
            request.getRequestDispatcher("/view/admin/video-add.jsp").forward(request, response);
        }
    }
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        if(url.contains("/admin/video/update")){
            ...
            String oldPoster = videoService.findById(video.getVideoId()).getPoster();
            ...
            try {
                ...
                if(posterPart.getSize() > 0){
                    ...
                    video.setPoster("default_poster.jpg");
                }
