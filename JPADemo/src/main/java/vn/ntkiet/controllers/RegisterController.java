...
public class RegisterController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		int roleid = req.getParameter("roleId") == null ? 1 : Integer.parseInt(req.getParameter("roleId"));
//		String selectedRole = req.getParameter("roleId");
...
//		}
		...
		boolean isSuccess = service.registerUser(username, password, email, 2, phone);
		if (isSuccess) {			
			//req.setAttribute("alert", alertMsg);
